...
if loop and loop.is_running():
    # If inside a running event loop, use create_task and await later, or refactor as needed
    # For now, set session to None or handle asynchronously in your app
    session = None  # Or: session = await session_service.create_session(...)
else:
    session = asyncio.run(
